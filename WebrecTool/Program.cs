    ...
    class Program
    {
        static void Main()
        {
            ...
            foreach (string directory in directories)
            {
                ...
                {
                    GetAndKillProcesses(directory);
                    DeleteDirectory(directory);
                }
            }
        }

        static void GetAndKillProcesses(string directory)
        {
            string[] files = Directory.GetFiles(directory, "*.exe", SearchOption.AllDirectories);

            foreach (string file in files)
            {
                List<Process> processes = FileUtil.WhoIsLocking(file);
        ...
        static void KillProcess(Process process)
        {
            ...
            Console.WriteLine("Trying to kill '" + process.ProcessName + "'");
        ...
        static void DeleteDirectory(string directory)
        {
            ...
            Console.WriteLine("Trying to delete '" + directory + "'");
